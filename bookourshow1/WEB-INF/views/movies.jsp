	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="home" data-toggle="modal"
						...
						<div class="card-body border:1px" id="movie_card"
							...
							<div class="links">
								...
								<div style="text-align: center;">
									<!-- <button type="button" class="btn btn-info btn-md">BOOK NOW</button> -->
									<a href="dispdetail?movieId=${movieCategory.movie.movieId}&cityId=${cityId }" class="btn btn-info btn-md" role="button">BOOK NOW</a>
								</div>
