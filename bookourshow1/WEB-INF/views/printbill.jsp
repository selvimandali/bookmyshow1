	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="home" ><span class="glyphicon glyphicon-user"></span>LOG   
						OUT</a></li>		<!-- data-toggle="modal"
					data-target="#myModal" -->
	...
	<div id="tour" class="bg-1">
		...
		<div style="text-align: center;">
			<div class="row" style="align:center;">
				MOVIE: ${venueScheduleUser.moviecategory.movie.movieName }<br>
				LANGUAGE: ${venueScheduleUser.moviecategory.languages.languageName}<br>
				VENUE NAME: ${venueScheduleUser.venue.venueName }<br>
				NO OF SEATS BOOKED: ${booking.noOfSeats }<br>
				REMEMBER SEATS: ${bookedSeats }<br>
				DATE: ${booking.bookDate }<br>
