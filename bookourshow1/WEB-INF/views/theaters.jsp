										...
										<div class="modal-content" style="text-align: center;">
											...
											<div class="modal-body" style="padding-bottom: 20px;">
													<c:forEach items="${venueList }" var="venue">
														<br><br>${venue.venueName}<br>
														<c:forEach items="${venue.timingList }" var="timing">

															<a role="button" href="dispseats?movieId=${movieId }&cityId=${cityId }&languageId=${languageId }&venueId=${venue.venueId}&bookDate=${bookDate}&timingId=${timing.timingId}" class="btn btn-info btn-md">
