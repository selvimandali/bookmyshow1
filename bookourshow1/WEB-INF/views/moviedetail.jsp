						...
						<div class="card-body border:1px" id="movie_card"
							...
							<div class="links">
								...
								<div style="text-align: center;">
									<button type="button" class="btn btn-info btn-md" data-backdrop="static" data-toggle="modal" data-target="${dest }">BOOK NOW</button>
								</div>
									...
									<div class="modal-dialog">
										...
										<div class="modal-content">
											...
											<div class="modal-body">
												<p>
												<form name="moviedetail" action="DispVenue"
												 method="post" onsubmit="dateValidate();">
